...
import com.example.bolo.os_application.media.helper.MeasureHelper;
...
//        requestLayout();
    ...
    private static final class InternalSurfaceHolderAdapter implements IRenderView.ISurfaceHolder {
        private SurfaceRenderView mSurfaceView;
        private SurfaceHolder mSurfaceHolder;

        public InternalSurfaceHolderAdapter(@NonNull SurfaceRenderView surfaceView,
    ...
    private static final class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void addRenderCallback(@NonNull IRenderCallback callback) {
            ...
            if (mSurfaceHolder != null) {
                surfaceHolder = new InternalSurfaceHolderAdapter(mWeakSurfaceView.get(), mSurfaceHolder);
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            ...
            ISurfaceHolder surfaceHolder = new InternalSurfaceHolderAdapter(mWeakSurfaceView.get(), mSurfaceHolder);
